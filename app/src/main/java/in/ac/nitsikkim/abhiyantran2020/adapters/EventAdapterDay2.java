...
public class EventAdapterDay2 extends RecyclerView.Adapter<EventAdapterDay2.EventViewHolder> {
    ...
    public EventAdapterDay2(ArrayList<EventModel> arrayList, Context context)
    {
